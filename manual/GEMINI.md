# Gemini Workspace for `manual-https-rust` (v0.2.0)
...
This document provides a developer-focused overview of the `manual-https-rust` (Manual variant), tailored for use with Gemini.
